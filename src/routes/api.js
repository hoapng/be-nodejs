...
const { postCreateCustomer, postCreateArrayCustomer, getAllCustomer, puttUpdateCustomer, deleteCustomer, deleteArrayCustomer } = require('../controllers/customerController');
